          ...
          <div>
            ...
            <nav className="space-y-1">
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-3 rounded-2xl text-xs font-extrabold transition text-left cursor-pointer ${activeTab === 'overview' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-3 rounded-2xl text-xs font-extrabold transition text-left cursor-pointer ${activeTab === 'users' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
          ...
          <div>
            ...
            <nav className="space-y-1">
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-3 rounded-2xl text-xs font-extrabold transition text-left cursor-pointer ${activeTab === 'activities' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-3 rounded-2xl text-xs font-extrabold transition text-left cursor-pointer ${activeTab === 'fraud' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-3 rounded-2xl text-xs font-extrabold transition text-left cursor-pointer ${activeTab === 'reviews' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
          ...
          <div>
            ...
            <nav className="space-y-1">
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-3 rounded-2xl text-xs font-extrabold transition text-left cursor-pointer ${activeTab === 'agreements' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-3 rounded-2xl text-xs font-extrabold transition text-left cursor-pointer ${activeTab === 'reports' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="bg-[#F8FAFB] p-1 rounded-xl flex items-center space-x-1 border-none text-[10px] font-extrabold uppercase select-none">
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${listingFilter === 'All' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'
                          }`}
                      >
                        All
                      </button>
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${listingFilter === 'Rent' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'
                          }`}
                      >
                        Rent
                      </button>
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${listingFilter === 'Selling' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'
                          }`}
                      >
                        Selling
                      </button>
                      ...
                      {paginatedListings.length === 0 ? (
                        ...
                        paginatedListings.map((listing) => (
                          <tr key={listing.id} className="hover:bg-[#F8FAFB]/40 transition group">
                            ...
                            {/* Category */}
                            <td className="py-4 px-4">
                              <span className={`px-2.5 py-1 rounded-lg text-[9px] font-extrabold uppercase ${listing.category === 'Rent'
                            ...
                            {/* Status */}
                            <td className="py-4 px-4">
                              <span className={`flex items-center space-x-1.5 text-[10px] font-bold ${listing.status === 'Active' ? 'text-emerald-600' :
                                listing.status === 'Deactivated' ? 'text-gray-400' :
                                  listing.status === 'Sold' ? 'text-blue-500' : 'text-amber-500'
                                }`}>
                                <span className={`w-1.5 h-1.5 rounded-full ${listing.status === 'Active' ? 'bg-emerald-500' :
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="bg-[#F8FAFB] p-1 rounded-xl flex items-center space-x-1 border-none text-[10px] font-extrabold uppercase select-none">
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${userFilter === 'All' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'
                        }`}
                    >
                      All Roles
                    </button>
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${userFilter === 'Tenant' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'
                        }`}
                    >
                      Tenants
                    </button>
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${userFilter === 'Landlord' ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'
                        }`}
                    >
                      Landlords
                    </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredUsers.length === 0 ? (
                  ...
                  filteredUsers.map((account) => (
                    <div
                      key={account.id}
                      className={`border rounded-3xl p-6 transition flex flex-col justify-between space-y-4 hover:shadow-md ${account.status === 'Suspended'
                    ...
                    >
                      ...
                      <div className="space-y-3.5">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="flex space-x-1.5">
                            <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase ${account.role === 'Landlord'
                              ? 'bg-purple-50 text-purple-600 border border-purple-100'
                              : 'bg-blue-50 text-blue-600 border border-blue-100'
                              }`}>
                              {account.role}
                            </span>
                            <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase ${account.status === 'Active'
                              ? 'bg-emerald-50 text-emerald-600 border border-emerald-100'
                      ...
                      <div className="pt-4 border-t border-gray-50 flex items-center justify-between gap-3 text-xs select-none">
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 px-3.5 rounded-xl font-extrabold transition cursor-pointer border flex items-center justify-center space-x-1.5 ${account.verified
                        ...
                        <button
                          ...
                          className={`py-2 px-3.5 rounded-xl font-extrabold transition cursor-pointer border ${account.status === 'Suspended'
                  ...
                  <div className="bg-[#F8FAFB] p-1 rounded-xl flex items-center space-x-1 border-none text-[10px] font-extrabold uppercase select-none">
                    {['All', 'Info', 'Success', 'Warning', 'Alert'].map((lvl) => (
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${activityFilter === lvl ? 'bg-[#1A1A1A] text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'
                          }`}
                      >
                        {lvl}
                      </button>
              ...
              <div className="divide-y divide-gray-50">
                {filteredActivities.length === 0 ? (
                  ...
                  filteredActivities.map((log) => (
                    <div
                      key={log.id}
                      className={`py-4 flex items-start gap-4 transition-colors ${log.type === 'Alert' ? 'bg-red-50/10' :
                        log.type === 'Warning' ? 'bg-amber-50/10' : ''
                        }`}
                    >
                      {/* Icon */}
                      <div className={`w-8 h-8 rounded-xl shrink-0 flex items-center justify-center ${log.type === 'Info' ? 'bg-blue-50 text-blue-500' :
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-1">
                          Source: <span className="text-gray-900 font-extrabold">{log.user}</span> &bull; Status: <span className={`font-extrabold ${log.type === 'Info' ? 'text-blue-500' :
                    ...
                    >
                      <div className="space-y-2 max-w-xl">
                        <div className="flex items-center space-x-2.5">
                          <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase ${flag.severity === 'High'
              ...
              <div className="space-y-4">
                {disputes.length === 0 ? (
                  ...
                  disputes.map((dispute) => (
                    <div
                      key={dispute.id}
                      className={`border rounded-[24px] p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition ${dispute.status === 'Open'
                    ...
                    >
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2.5">
                          <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase ${dispute.status === 'Open'
              ...
              <div className="space-y-4">
                {reviews.length === 0 ? (
                  ...
                  reviews.map((review) => (
                    <div
                      key={review.id}
                      className={`border rounded-[24px] p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition ${review.status === 'Deleted' ? 'opacity-40 bg-gray-50/50 border-gray-100' :
                        review.status === 'Flagged' ? 'border-amber-100 bg-amber-50/10' : 'bg-white border-gray-100'
                        }`}
                    >
                      <div className="space-y-2 flex-1 max-w-xl">
                        <div className="flex items-center space-x-2.5">
                          <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase ${review.status === 'Flagged' ? 'bg-amber-500 text-white' :
                      ...
                      <div className="flex items-center gap-2 text-xs select-none shrink-0 self-start md:self-center">
                        {review.status === 'Flagged' ? (
                          ...
                          <div className={`flex items-center font-extrabold text-xs space-x-1 py-2 px-4 rounded-xl border ${review.status === 'Approved'
