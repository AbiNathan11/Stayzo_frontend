...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#1A1A1A] text-white font-sans selection:bg-[#F26B27] selection:text-white p-8">
      <div className="max-w-7xl mx-auto pt-4">
        <div className="flex justify-between items-center mb-16 border-b border-gray-800 pb-6">
          <Link href="/" className="text-4xl font-serif italic font-extrabold text-white hover:text-[#F26B27] transition">
            Stayzo. Admin
          </Link>
