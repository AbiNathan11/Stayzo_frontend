    ...
    <div className="flex flex-col items-center justify-center min-h-[75vh] text-center px-4 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <Link
          ...
          className="flex items-center justify-center bg-white border-2 border-[#1A1A1A] hover:bg-gray-50 text-[#1A1A1A] px-10 py-4 rounded-full text-xs font-bold tracking-widest uppercase transition"
        >
          Learn More
        </Link>
      </div>
