...
function SearchContent() {
  ...
  const selectedProperty = activePropertyId ? sortedListings.find(l => l.id === activePropertyId) : null;
            ...
            {loading ? (
              ...
              sortedListings.map((listing) => (
                ...
                >
                  ...
                  {/* Details */}
                  <div className="flex-1 flex flex-col pt-1 gap-0.5">
                    <p className="text-base font-medium text-gray-800 leading-snug">{listing.title}</p>
                    <div className="flex items-center justify-between flex-wrap gap-x-2">
                      ...
                      <span className="flex items-center text-xs text-gray-700 font-medium">
                        <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400 stroke-none mr-0.5" />
                        {listing.rating > 0
