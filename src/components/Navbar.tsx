      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex justify-between items-center">
        ...
        {isSearchPage ? (
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/auth" className="bg-[#1A1A1A] hover:bg-black text-white px-5 py-2.5 rounded-full text-xs font-bold tracking-wider uppercase transition flex items-center shadow-sm">
